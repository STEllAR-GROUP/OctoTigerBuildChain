...
${CMAKE_COMMAND} \
    ...
    -DOCTOTIGER_WITH_HIP=ON \
    -DOCTOTIGER_WITH_FAST_FP_CONTRACT=OFF \
    ...
    -DOCTOTIGER_WITH_HYDRO_HOST_HPX_EXECUTOR=OFF \
    -DOCTOTIGER_WITH_KOKKOS_MULTIPOLE_TASKS=1 \
    -DOCTOTIGER_WITH_KOKKOS_MONOPOLE_TASKS=1 \
    -DOCTOTIGER_WITH_KOKKOS_HYDRO_TASKS=1 \
    -DOCTOTIGER_WITH_FORCE_SCALAR_KOKKOS_SIMD=${OCT_WITH_KOKKOS_SCALAR} \
    -DOCTOTIGER_KOKKOS_SIMD_LIBRARY=KOKKOS \
    -DOCTOTIGER_KOKKOS_SIMD_EXTENSION=DISCOVER \
