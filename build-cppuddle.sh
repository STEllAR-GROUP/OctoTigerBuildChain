...
${CMAKE_COMMAND} \
    ...
    -DCPPUDDLE_WITH_HPX_MUTEX=ON \
    -DCPPUDDLE_WITH_HPX_AWARE_ALLOCATORS=ON \
    -DCPPUDDLE_WITH_MAX_NUMBER_GPUS=2 \
    -DCPPUDDLE_WITH_MAX_NUMBER_WORKERS=128 \
    -DCPPUDDLE_WITH_BUFFER_RECYCLING=ON \
    -DCPPUDDLE_WITH_AGGRESSIVE_CONTENT_RECYCLING=ON \
